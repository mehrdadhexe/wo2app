...
<div class="container row" >
    <div class="col-md-4 col-sm-12" style="margin: 0 auto;float: none;">
        <div class="panel panel-default" style="margin-top: 10px">
            ...
            <div class="panel-body">
                <div class="col-md-12">
                    <input id="search_product_banner1" class="form-control" placeholder="نام محصول را جستجو کنید ...." type="text">
                </div>
                ...
                <form role="form" method="post">
                    <div class="col-md-12 pull-right form-group" style="margin-top: 10px">
                        ...
                        <div class="col-md-2 pull-right"  style="margin-top: 20px">
                            <button type="button" id="btn_remove_option" class="btn btn-default btn-xs pull-right"> Remove </button>
                        </div>
                    </div>
                    <div class="form-group">
                        <input type="text" required placeholder="عنوان لیست" class="form-control" name="title" />
                    </div>
                    <div class="col-md-12  text-center" >
                        <button type="submit" onclick="jQuery('#sel_inserted_product option').prop('selected', true);" name="ins_vizhe" class="btn btn-sm btn-default"> Save </button>
                    </div>
                </form>
    ...
    <div class="col-sm-12 col-md-12" style="margin: 0 auto;float: none;">
        <div class="panel panel-default">
            <div class="panel-heading"><h3 class="panel-title"><strong> لیست پیشنهادات ویژه </strong></h3></div>
            <div class="panel-body">
