...
$current_url= 'admin.php?page=woo2app/woo2app_design/woo2app_show_design.php';
...
<div class="wrap">
    ...
    <h2 class="nav-tab-wrapper koodak">
        ...
        <a href="<?= $current_url.'&tab=chideman' ?>" class="nav-tab <?php echo ('chideman' == $tab) ? 'nav-tab-active' : ''; ?>">چیدمان صفحه اصلی</a>
...
if($tab == 'chideman'){
    ...
    <ul class="subsubsub" style="margin-top: 10px">
        ...
        <li><a href="<?= $current_url.'&tab=chideman&sub_page=banner' ?>" class="<?= ($page =="banner")?'current':'';?>"> بنر تکی </a> | </li>

        <li><a href="<?= $current_url.'&tab=chideman&sub_page=banner2' ?>" class="<?= ($page =="banner2")?'current':'';?>" > بنر 2 تایی</a> | </li>

        <li><a href="<?= $current_url.'&tab=chideman&sub_page=banner3' ?>" class="<?= ($page =="banner3")?'current':'';?>" >بنر 3 تایی Right</a> | </li>

        <li><a href="<?= $current_url.'&tab=chideman&sub_page=banner3_L' ?>" class="<?= ($page =="banner3_L")?'current':'';?>" >بنر 3 تایی Left </a> | </li>

        <li><a href="<?= $current_url.'&tab=chideman&sub_page=banner4' ?>" class="<?= ($page =="banner4")?'current':'';?>" >بنر 4 تایی</a> | </li>

        <li><a href="<?= $current_url.'&tab=chideman&sub_page=product_list' ?>" class="<?= ($page =="product_list")?'current':'';?>" >  محصولات متفرقه </a> | </li>

        <li><a href="<?= $current_url.'&tab=chideman&sub_page=vertical_list' ?>" class="<?= ($page =="vertical_list")?'current':'';?>" > لیست محصولات </a> | </li>

        <li><a href="<?= $current_url.'&tab=chideman&sub_page=list_post' ?>" class="<?= ($page =="list_post")?'current':'';?>" > لیست پست ها </a> | </li>

        <li><a href="<?= $current_url.'&tab=chideman&sub_page=sort_chideman' ?>" class="<?= ($page =="sort_chideman")?'current':'';?>" > مرتب سازی </a> | </li>
